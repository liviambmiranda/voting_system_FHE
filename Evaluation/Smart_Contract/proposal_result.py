...
def proposal_accepted(id = 1):
    ...
    transaction = contract.functions.Is_Proposal_Accepted(id).build_transaction({
...
csv_file = 'proposal_accepted.csv'
results = []

for _ in range(1000):
    start_time = time.perf_counter()
    tx_hash = proposal_accepted()
